...
export function ProjectDocument({ titleBlock, children, checkered }: ProjectDocumentProps) {
  return (
    <div className='project-document'>
      <div className='project-document-container'>
        ...
        <div className={`project-document-content ${checkered ? 'project-document-checkered' : ''}`}>
          {children}
        </div>
      </div>
    </div>
