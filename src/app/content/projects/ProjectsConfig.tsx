...
export const projects: Project[] = [
  ...
  },
  {
    name: 'TMusic',
    id: 'tmusic',
    iconPath: 'https://github.com/tmunz/tmusic/blob/master/public/icon-256x256.png?raw=true',
    description: 'Web Application to visualize Music inspired by legendary Cover Art.',
    githubLink: 'https://github.com/tmunz/tmusic',
    component: <iframe width='100%' height='100%' frameBorder="0" src='https://tmunz.github.io/tmusic' />,
    highlight: true,
  },
  {
    name: 'Magic Anagram',
