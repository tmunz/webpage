export interface KnowledeNodeData {
  id: string;
  name: string;
}

export interface KnowledeLinkData {
  source: string;
  target: string;
}

export const nodeData: KnowledeNodeData[] = [
  { id: 'root', name: 'me' },
  { id: 'java', name: 'Java' },
  { id: 'spring', name: 'Spring Boot' },
  { id: 'ee', name: 'Java EE' },
  { id: 'wicket', name: 'Apache Wicket' },
  { id: 'csharp', name: 'C#' },
